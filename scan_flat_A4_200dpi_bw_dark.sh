...
if [[ $# -ge 1 ]]; then
    ...
    for (( i=1; i<=$1; i++ )); do
        ...
        # scan original
        scanimage --mode=Lineart --resolution=200 --brightness=100 --contrast=300 -x 210 -y 295 >/home/pi/scan_$i.pnm
    ...
    # scan original
    scanimage --mode=Lineart --resolution=200 --brightness=700 -x 210 -y 295 >/home/pi/scan.pnm
